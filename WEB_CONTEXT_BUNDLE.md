...
```json
{
  ...
  "problem_contract": {
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Rule30中央列0/1极限频率. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Rule30中央列0/1极限频率",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "cf6ceb9a210177148767d5ed1ab9ab818ea6d1109a93a680892d86e8532ac493"
}
```
